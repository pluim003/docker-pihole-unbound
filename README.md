...
Note: October 6th 2024. Adding more recent version of unbound through apt doesn't work anymore on newer releases. The latest docker-image with tag 2024.07.0 contains the latest pihole-image 2024.07.0 with Unbouond v1.17.1. 
The nightly docker-image is currently a working version with the latest pihole-image (tag 2024.07.0) and the most recent unbound-version 1.21.1. I can't use the nightly pihole-image as this gives other troubles which I will look into it later.
